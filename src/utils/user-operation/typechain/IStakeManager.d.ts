...
export class IStakeManager extends BaseContract {
  ...
  filters: {
    ...
    "StakeLocked(address,uint256,uint256)"(
      account?: string | null,
      totalStaked?: null,
      unstakeRelaySec?: null
    ): TypedEventFilter<
      [string, BigNumber, BigNumber],
      { account: string; totalStaked: BigNumber; unstakeRelaySec: BigNumber }
    >;
    ...
    "StakeWithdrawn(address,address,uint256)"(
      account?: string | null,
      withdrawnAddress?: null,
      amount?: null
    ): TypedEventFilter<
      [string, string, BigNumber],
      { account: string; withdrawnAddress: string; amount: BigNumber }
    >;
